...
const DEMO_USER = { id: "demo-001", username: "demo", email: "demo@aibyai.dev", role: "admin" as const };
          ...
          <CardContent>
            ...
            <div className="mt-4 pt-4 border-t border-border/40">
              <Button
                type="button"
                variant="ghost"
                className="w-full gap-2 text-amber-400 hover:text-amber-300 hover:bg-amber-400/10 border border-amber-400/20"
              ...
              <p className="text-center text-xs text-muted-foreground mt-2">
                Explore the full UI with mock data
              </p>
            </div>
          </CardContent>
        </Card>
