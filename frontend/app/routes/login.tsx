...
const OAUTH_ERRORS: Record<string, string> = {
  email_conflict: "This Google account is already linked to another workspace.",
  oauth_failed: "Google sign-in failed. Please try again.",
  google_not_configured: "Google sign-in is not available. Contact support.",
};
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-3">
          <div className="flex items-center justify-center gap-2">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 relative">
              <span className="text-lg font-bold text-primary">J</span>
              <div className="absolute inset-0 rounded-2xl bg-primary/20 blur-sm" />
            </div>
          </div>
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Judica</h1>
            <p className="text-sm text-muted-foreground mt-1">Multi-perspective AI deliberation</p>
          </div>
        </div>

        <Card>
          <CardHeader className="pb-2">
            <p className="text-sm font-medium text-center text-muted-foreground">Sign in to your workspace</p>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                type="button"
              >
                <svg className="size-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
