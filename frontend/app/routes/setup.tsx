  ...
  return (
    <div className="space-y-7">
      <div className="text-center space-y-3">
        ...
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Welcome to Judica</h2>
...
export default function SetupPage() {
  ...
  const finish = () => {
    ...
    localStorage.setItem("judica_prefs", JSON.stringify({
    ...
    localStorage.setItem("judica_setup_done", "1");
      ...
      <div className="w-full max-w-md space-y-5">
        ...
        >
          ...
          <div className="flex gap-2 mt-6">
            ...
            >
              {step === 4
                ? <><ArrowRight className="size-3.5" /> Enter Judica</>
