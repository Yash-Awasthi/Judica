...
const PHASE_ICONS: Record<ResearchPhase, React.ReactNode> = {
  clarification:     <Lightbulb className="size-3.5" />,
  planning:          <Layers className="size-3.5" />,
  researching:       <Search className="size-3.5" />,
  thinking:          <Cpu className="size-3.5" />,
  generating_report: <FileText className="size-3.5" />,
  complete:          <CheckCircle2 className="size-3.5" />,
  failed:            <AlertCircle className="size-3.5" />,
  timed_out:         <Clock className="size-3.5" />,
};
