/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f639ea75baea514eb6b4c49d9a66a2a8)
// Runtime types generated with workerd@1.20260424.1 2026-02-28 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VALUE_FROM_CLOUDFLARE: "Starter template running on Cloudflare";
		DATA_PROXY: Service<typeof import("./workers/app").LocalDataProxyService>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_VIRTUAL_MODEL" | "VALUE_FROM_CLOUDFLARE">> {}
}
