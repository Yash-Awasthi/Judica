      ...
      return (
        <div role="alert" aria-live="assertive" className="flex flex-col items-center justify-center h-screen bg-bg text-text p-8 text-center font-sans">
          ...
          <p className="text-white/40 mb-6 max-w-sm text-sm leading-relaxed">
            {isChunkError 
              ? "A new version of the app might be available. Please reload to update." 
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-[var(--accent-mint)] text-black rounded-xl hover:opacity-90 transition-all text-sm font-bold"
            >
              Reload page
            </button>
            <button
