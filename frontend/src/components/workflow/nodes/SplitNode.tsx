...
import { Split, Share2 } from "lucide-react";
        ...
        <div className="px-5 py-3.5 bg-gradient-to-b from-slate-500/10 to-transparent flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-200">Parallelizer</span>
              <span className="text-[9px] font-mono text-slate-500/60 uppercase tracking-widest leading-none">STREAM_SPLIT</span>
            </div>
          </div>
          <Share2 size={14} className="text-slate-500/30" />
        </div>
