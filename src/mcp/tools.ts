/**
 * MCP Tool Definitions — tools exposed by the aibyai MCP server.
 *
...
export const SEARCH_TOOL: MCPToolDefinition = {
  name: "aibyai_search",
  description:
    "Search the aibyai knowledge base using hybrid search (vector + keyword). " +
...
export const LIST_KNOWLEDGE_BASES_TOOL: MCPToolDefinition = {
  name: "aibyai_list_knowledge_bases",
...
export const ASK_COUNCIL_TOOL: MCPToolDefinition = {
  name: "aibyai_ask",
  description:
    "Ask a question to the aibyai council (multi-model deliberation). " +
...
export const LIST_CONVERSATIONS_TOOL: MCPToolDefinition = {
  name: "aibyai_list_conversations",
  description: "List recent conversations with the aibyai council.",
  parameters: [
    {
      name: "limit",
