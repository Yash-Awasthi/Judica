...
import type { ExtractedEntity } from "../../services/ner.service.js";
...
export const memories = pgTable(
  "Memory",
  {
    ...
    /** Named entities extracted from this chunk (populated when NER_ENABLED=true). */
    entities: jsonb("entities").$type<ExtractedEntity[]>().default([]),
