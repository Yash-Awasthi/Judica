...
import { hybridSearch, enhancedHybridSearch, enrichWithParentContext, type DateRange } from "./vectorStore.service.js";
...
export async function loadRAGContext(
  ...
  try {
    ...
    let chunks = useHyde
      ? await enhancedHybridSearch(userId, query, kbId, k, true, undefined, dateRange)
      : await hybridSearch(userId, query, kbId, k, undefined, dateRange);
